...
import 'package:geo_snap/src/core/di/register_module.dart' as _i20;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i16.AttendanceBloc>(() => _i16.AttendanceBloc(
    ...
    gh.factory<_i17.GetPendingUploads>(
        () => _i17.GetPendingUploads(gh<_i12.MediaRepository>()));
    gh.factory<_i18.SnapBloc>(() => _i18.SnapBloc(
          gh<_i14.SaveCapturedImage>(),
          gh<_i17.GetPendingUploads>(),
        ));
    gh.factory<_i19.SyncBloc>(
        () => _i19.SyncBloc(getPendingUploads: gh<_i17.GetPendingUploads>()));
    return this;
  }
}
